...
class ShopItemRaffleServiceV2Test extends TestConfig {
    ...
    void checkNotExistShopItem() throws InterruptedException {
        // given
        long userId = 1;
        long shopItemId = 1;
        ...
        ShopItemRaffleException ex = assertThrows(ShopItemRaffleException.class, () ->
                shopItemRaffleService.raffleV2(userId, shopItemId));
    ...
    void checkNotEnoughUserGiftCardCount_1() {
        ...
        // when & then
        ShopItemRaffleException ex = assertThrows(ShopItemRaffleException.class, () ->
                shopItemRaffleService.raffleV2(userId, shopItem.getId()));
    ...
    void doRaffle_1() {
        ...
        // when
        boolean resultRaffle = shopItemRaffleService.raffleV2(userId, shopItem.getId());
